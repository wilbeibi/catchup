...
For advance notice before quota handoffs, enable [quota visibility in your statusline](recipes/quota-visibility.md), or set up an active [quota reminder](recipes/quota-reminder.md) at 25% left.
