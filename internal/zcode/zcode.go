...
// of only reporting that one exists. The ordering is readThread's - message.sequence,
// which this schema's doc calls the reliable field, not time_created - so the quoted
