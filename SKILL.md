...
- Output: Markdown, conversation plus `failure:` entries for tool calls the agent's log marked failed; other tool calls/reasoning already stripped; `-i` for metadata only.
